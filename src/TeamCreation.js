...
function TeamCreation({
  ...
  const createTeam = () => {
    ...
    if (usersToTeamArr.length === 2 && !team1hook[4]) {
      ...
      createTeam5();
      //replace the button
      document.getElementById("createTeamButton").classList.add("displayNone");
      document.getElementById("buttonToPage3").classList.remove("displayNone");
    }
  };
  ...
  return (
    <section className="teamCreation__section" id="page2">
