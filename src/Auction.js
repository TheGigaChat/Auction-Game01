...
function Auction({
  ...
  /* moneyChecker */
  /* moneyChecker */
  const moneyChecker = (currentTeamMoney, currentTeamName) => {
    if (currentTeamMoney - curPrice <= 0) {
      document.getElementById("alert").classList.remove("displayNone");
      setTimeout(() => {
        document.getElementById("alert").classList.add("displayNone");
      }, 3000);
    } else {
    ...
    <section className="container1" id="container1">
      ...
      <section className="team1-3" id="team1-3">
        <section
          ...
          id="team1"
          onClick={() => {
            moneyChecker(team1hook[5], team1hook[3]);
          }}
        >
          <div>{team1hook[3]}</div>
          <section>
        ...
        <section
          ...
          id="team2"
          onClick={() => {
            moneyChecker(team2hook[5], team2hook[3]);
          }}
        >
          <div>{team2hook[3]}</div>
          <section>
        ...
        <section
          ...
          id="team3"
          onClick={() => {
            moneyChecker(team3hook[5], team3hook[3]);
          }}
        >
          <div>{team3hook[3]}</div>
          <section>
      ...
      <section className="team4-5" id="team4-5">
        <section
          ...
          id="team4"
          onClick={() => {
            moneyChecker(team4hook[5], team4hook[3]);
          }}
        >
          <div>{team4hook[3]}</div>
          <section>
        ...
        <section
          ...
          id="team5"
          onClick={() => {
            moneyChecker(team5hook[5], team5hook[3]);
          }}
        >
          <div>{team5hook[3]}</div>
          <section>
